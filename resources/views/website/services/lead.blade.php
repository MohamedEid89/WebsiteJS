				...
				<div class="menu-header">
					...
					<div class="custom-nav" role="navigation">
						<ul class="nav-list onepge">
							...
							<li><a href="#whywe" class="menu-links">Why Choose Us</a></li>						
...
<a href="#" class="btn-main bg-btn lnk wow fadeInUp" data-wow-delay=".6s" data-bs-toggle="modal" data-bs-target="#menu-popup">Get Strategy Call <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
</div>
</div>
...
<p class="mt10">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to
...
<a href="#" class="btn-main bg-btn2 lnk"> Free Quote<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
</div>
</div>
</div>
</section>
...
<div class="col-lg-6">
<div class="single-image"> <img src="images/about/marketing-service.png" alt="hero image" class="img-fluid" /> </div>
...
<a href="#" class="btn-outline lnk mt30">Get Strategy Call  <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
</div>
</div>
</div>
</div>
...
<div class="clients-logo"><img src="images/client/clients-7.png" alt="text" class="img-fluid" /></div>
</li>
<li class=" wow fadeIn" data-wow-delay="1.4s">
<div class="clients-logo"><img src="images/client/clients-8.png" alt="text" class="img-fluid" /></div>
</li>
<li class=" wow fadeIn" data-wow-delay="1.6s">
<div class="clients-logo"><img src="images/client/clients-9.png" alt="text" class="img-fluid" /></div>
</li>
<li class=" wow fadeIn" data-wow-delay="1.8s">
<div class="clients-logo"><img src="images/client/clients-10.png" alt="text" class="img-fluid" /></div>
</li>
<li class=" wow fadeIn" data-wow-delay="2s">
<div class="clients-logo"><img src="images/client/clients-11.png" alt="text" class="img-fluid" /></div>
</li>
</ul>
</div>
</div>
